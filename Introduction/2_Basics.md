...
| type       | An object type defines multiple fields with their type that can be used throughout calculations
...
function FirstFunction       // no indentation, start of a function component
  ...
  Tax = Income * TaxRate     // 2 spaces indentation, the assignment is part of the function code
